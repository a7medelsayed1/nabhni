    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemBuilder:(context,index)=> GestureDetector(
          onTap: () => context.pushName(Routes.newsdetails),
          child: Container(
                  ...
                  children: [
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Column(
                          children: [
                            Text('''إنهاء أزمة تخفيف الأحمال أهم انجازات "الكهرباء" خلال 2024''',softWrap: true,overflow: TextOverflow.visible,style: Textutils.bodybold16,),
