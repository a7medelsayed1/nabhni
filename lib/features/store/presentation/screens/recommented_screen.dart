...
class RecommentedScreen extends StatefulWidget {
  const RecommentedScreen({super.key});

  @override
  State<RecommentedScreen> createState() => _RecommentedScreenState();
}
 bool vertical=false;
class _RecommentedScreenState extends State<RecommentedScreen> {
  @override
